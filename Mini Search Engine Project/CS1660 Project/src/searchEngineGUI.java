...
public class searchEngineGUI extends JFrame implements ActionListener {
    ...
    String projectId = "cs1660-project-shr80";
    String clusterName = "project-cluster";
    String bucketName = "dataproc-staging-us-central1-45943336235-k5wuf6om";
    ...
    void setLayout() {
    	...
    	loadingLabel.setBounds(0, 550, 800, 50);
        ...
        invalidEntryLabel.setBounds(0, 125, 800, 50);
	   		...
	   		public void run() {
	   			...
	   			SwingUtilities.invokeLater(new Runnable() {
	   	    		public void run() {
	   	    			...
	   	    			System.out.println("\nSearch job finished, preparing results");
		   	 			if(content == null) {
		   	 				System.out.println("\nInvalid term, returning to search page");
		   	 				invalidEntryLabel.setText(termToSearch + " is an invalid term. Please enter a valid term.");
		   	 				...
		   	 				searchResultLabel.setText("Search results for: " + termToSearch);
	   		...
	   		public void run() {
	   			...
	   			SwingUtilities.invokeLater(new Runnable() {
	   	    		public void run() {
	   	    			...
	   	    			System.out.println("\nTop-N job finished, preparing results");
		   	 			if(content == null) {
		   	 				System.out.println("\nInvalid N value, returning to Top-N page");
		   	 				invalidEntryLabel.setText(nValue + " is an invalid number. Please enter a valid number.");
		   	 				invalidEntryLabel.setVisible(true);
		   	 				loadingLabel.setVisible(false);
		   	 				topNField.setText("");
		   	 			} else if (content.isEmpty()) {
